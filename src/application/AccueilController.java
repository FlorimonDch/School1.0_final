		...
		try {
			...
			if (rs2.next()) {
				...
				case 1:
					...
					loader = new FXMLLoader(getClass().getResource("/application/accueilAdmin.fxml"));
				...
				case 2:
					...
					loader = new FXMLLoader(getClass().getResource("/application/accueilEtudiant.fxml"));
				...
				case 3:
					...
					loader = new FXMLLoader(getClass().getResource("/application/accueilSecretaire.fxml"));
				...
				case 4:
					...
					loader = new FXMLLoader(getClass().getResource("/application/accueilDirecteur.fxml"));
				...
				case 5:
					...
					loader = new FXMLLoader(getClass().getResource("/application/accueilEnseignant.fxml"));
